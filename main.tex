...
\begin{figure}[!htb]
	\begin{center}
		\includegraphics[width=0.8\linewidth]{time-domain-reflectrometer.jpg}
	\end{center}
...
\begin{figure}[!htb]
	\begin{center}
		\includegraphics[width=0.8\linewidth]{time-domain-reflectrometer-dtf-instructions.jpg}
	\end{center}
...
\begin{figure}[!htb]
	\begin{center}
		\includegraphics[width=0.8\linewidth]{time-domain-reflectrometer-dtf-test.jpg}
	\end{center}
