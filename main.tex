...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \TODO{X End CNS II to Comparator RG-58 Cable}
        \item \TODO{Y End VEA to Roof GPS Antenna Cable}
        \item \TODO{Y End CNS II to Comparator RG-58 Cable}
    \end{itemize}
...
\begin{center}
  ...
  \begin{tabular}{ | l | l | l | l | }
    ...
    X-End VEA to Rooftop GPS Antenna    &                       &                       & \\ \hline
...
After much back-and-forth (Appendix~\ref{sec:midnightbug}), we've decided to remove the CNS II Clocks and return them to the manufacturer for firmware updates. We will be removing these as part of the cable-length measurement task (Sec.~\ref{sec:cable-lengths}).
...
LHO X Frontend:
\begin{itemize}
    \item \texttt{H1:CAL-PCALX\_OFS\_AOM\_DRIVE\_MON\_EXC}
    \item \texttt{H1:CAL-PCALX\_OFS\_ERR\_EXC}
    \item \texttt{H1:CAL-PCALX\_OFS\_PD\_EXC}
    \item \texttt{H1:CAL-PCALX\_WS\_PD\_EXC}
    \item \texttt{H1:CAL-PCALX\_DARM\_EXC}
    \item \texttt{H1:CAL-PCALX\_TEMP1\_EXC}
    \item \texttt{H1:CAL-PCALX\_TEMP2\_EXC}
    \item \texttt{H1:CAL-PCALX\_SWEPT\_SINE\_EXC}
    \item \texttt{H1:CAL-PINJX\_HARDWARE\_EXC}
\end{itemize}
For Y Frontend, \texttt{PCALX} becomes \texttt{PCALY}. For LLO, \texttt{H1} becomes \texttt{L1}. 
\clearpage
...
\begin{center}
  \begin{tabular}{ | l | l | l | l | }
    ...
    Corner A: RF Ocsillators                        & 5         & 118                     &  \\ \hline
    ...
    Y-End: RF Oscillators                 & 2         & 118               & ? \\ \hline
    ...
    X-End: RF Oscillators                 & 2         & 118            &  ? \\ \hline
