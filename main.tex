...
\textbf{DO NOT check whether the end station Timing \textit{Diagnostic} System CNS II Clocks were updated} to fix the midnight firmware bug issue. There has been some confusion about whether this needs fixing, but during our last visit, Dave Barker said it is probably not worth updating the CNS II firmware given that we haven't seen any other problems besides the midnight bugs. This issue has been addressed and \textbf{no time should be spent on it}. 
...
\TODO{Thank people. At LHO we usually work with Dave Barker, Richard McCarthy, John Zweizig, and Daniel Sigg. We've also worked with Jenne Driggers.}
...
\begin{figure}[!htb]
	\begin{center}
		\includegraphics[width=0.8\linewidth]{rainer-performing-tdr.jpg}
	\end{center}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.8\linewidth]{endstation-antenna-cable.jpeg}
	\end{center}
...
\end{figure}
\begin{figure}
  \includegraphics[width=\linewidth]{cesium-clock.png}
